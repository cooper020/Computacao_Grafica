...
int loadPoints(string filename) {
    ...
    for (int i = 0; i < numPoints; i++) {
        ...
        Point point3;
        char separator;
        file >> point1.x >> separator >> point1.y >> separator >> point1.z >> separator >> point2.x >> separator >> point2.y >> separator >> point2.z >> separator >> point3.x >> separator >> point3.y;
        
        vertexPoints.push_back(point1.x);
        vertexPoints.push_back(point1.y);
        vertexPoints.push_back(point1.z);

        normalPoints.push_back(point2.x);
        normalPoints.push_back(point2.y);
        normalPoints.push_back(point2.z);

        texturePoints.push_back(point3.x);
        texturePoints.push_back(point3.y);
    }
